...
class TrelloFacadeTest {
    ...
    void shouldFetEmptyList(){
        ...
        List<TrelloBoard> mappedTrelloBoards = List.of(new TrelloBoard("test","1",mappedTrelloLists));
    ...
    void shouldFetchTrelloBoards() {
        ...
        List<TrelloBoard> mappedTrelloBoards =
                List.of(new TrelloBoard("test", "1", mappedTrelloLists));
